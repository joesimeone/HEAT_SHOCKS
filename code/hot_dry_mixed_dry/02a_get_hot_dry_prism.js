//Assuming you add shapefiles to google earth engine / copy this into their code editor


var uniqueID = 'GEOID10';
var featColl = hd_md_counties.select(uniqueID);
...
// Export info
var exportFolder = 'GEE_PRISM_HDMD_ZIP';
var filenameBase = 'hot_dry_mixed_dry' + scale + 'm_';
